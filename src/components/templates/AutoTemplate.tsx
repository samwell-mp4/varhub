      ...
      <div className="px-4 pt-3 pb-3 bg-gradient-to-b from-black/85 via-black/40 to-transparent">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            {subtitle && (
              <p className="leading-relaxed mt-0.5" style={{ fontSize: subtitleSize ?? 13, fontWeight: (subtitleBold ?? false) ? 700 : 400, color: subtitleColor || '#a1a1aa', wordBreak: 'break-word', overflowWrap: 'break-word' }}>
                {subtitle}
              </p>
            )}
          </div>
